...
export default function ContactPage({ params }: Props) {
  const { memorial: slug } = use(params)
  ...
  if (!memorial) return <p className="p-8 text-center">Memorial not found.</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-muted-foreground mb-2">
                    <a href={`tel:${memorial.contactPhone}`} className="text-primary hover:underline">
                      {memorial.contactPhone}
                    </a>
                  </p>
                ...
                <div className="border-t border-border pt-4">
                  ...
                  <p className="text-muted-foreground mb-1">{memorial.familyContactName}</p>
                  <p className="text-muted-foreground">
                    <a href={`tel:${memorial.familyContactPhone}`} className="text-primary hover:underline">
                      {memorial.familyContactPhone}
                    </a>
                  </p>
            ...
            <Card className="bg-card border-border">
              ...
              <CardContent>
                <p className="text-muted-foreground mb-2">
                  <a href={`mailto:${memorial.contactEmail}`} className="text-primary hover:underline">
                    {memorial.contactEmail}
                  </a>
                </p>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    {memorial.faqDonationsText} Please visit our{" "}
                    <Link href={`/${slug}/donations`} className="text-primary hover:underline">donations page</Link>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">{memorial.faqDressCode}</p>
                </div>
              </div>
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    Children are absolutely welcome at both the service and reception. A quiet room will be available if needed.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-foreground mb-2">Is there parking available?</h4>
                  <p className="text-muted-foreground text-sm">
                    Yes, free parking is available at both venues with accessible spaces. Additional street parking is also available nearby.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    ...
                    <Link href={`/${slug}/leave-message`} className="text-primary hover:underline">message page</Link>
                    {" "}or{" "}
                    <Link href={`/${slug}/add-memories`} className="text-primary hover:underline">memories section</Link>.
