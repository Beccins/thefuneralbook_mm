...
export function ContactClient({ slug, memorial }: Props) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <Card className="bg-card border-border">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="border-t border-border pt-4">
                  ...
                  <p className="text-muted-foreground">
                    <a href={`tel:${memorial.familyContactPhone}`} className="text-primary hover:underline">{memorial.familyContactPhone}</a>
                  </p>
            ...
            <Card className="bg-card border-border">
              ...
              <CardContent>
                <p className="text-muted-foreground mb-2">
                  <a href={`mailto:${memorial.contactEmail}`} className="text-primary hover:underline">{memorial.contactEmail}</a>
                </p>
