...
And he that was dead came forth, bound hand and foot with graveclothes: and his face was bound about with a napkin. Jesus saith unto them, Loose him, and let him go.`,
  ...
  // ─── Donations ───────────────────────────────────────────────────────────────
  donationsIntro:
    "In lieu of flowers, the family requests donations be made to one of the following organizations that were dear to David's heart. Your generosity will continue his legacy of giving and community service.",
  donationsShareText:
    "Honor David's memory by making a donation to causes he cared about. Help continue his legacy of giving and community service.",
  charities: [
    {
      id: "cancer-council",
